            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <div class="row">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?= base_url().'customer/create'; ?>"><i class="fa fa-plus-square" aria-hidden="true"></i>Create New Customer</a></li>
                </ol>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="row">
                    <form id="create_customer_form" action="<?= base_url().'customer/save/new'; ?>" method="post">
                      <!-- customer name -->
                      <div class="form-group <?php if(strlen(form_error('customer_name')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="customer_name" value="<?= set_value('customer_name');  ?>" placeholder="Enter customer name" data-parsley-minlength="3" data-parsley-maxlength="100" data-parsley-required="true" required/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('company_name')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="company_name" value="<?= set_value('company_name');  ?>" placeholder="Enter company name" data-parsley-minlength="5" data-parsley-maxlength="120" data-parsley-required="true" required/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('mobile_number')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="mobile_number" value="<?= set_value('mobile_number');  ?>" placeholder="Enter mobile number" data-parsley-required="false"/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('email_address')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="email" class="form-control" name="email_address" value="<?= set_value('email_address');  ?>" placeholder="Enter email address" data-parsley-type="email" data-parsley-required="false"/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('address')) != 0) echo 'has-error'; ?>">
                        ...
                        <textarea name="address" class="form-control" rows="4" placeholder="Enter address" data-parsley-minlength="15" data-parsley-maxlength="300" data-parsley-required="true" required><?= set_value('address');  ?></textarea>
                      ...
                      <div class="form-group <?php if(strlen(form_error('gst_number')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" name="gst_number" class="form-control" value="<?= set_value('gst_number'); ?>" placeholder="Enter gst number" data-parsley-required="true" required/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('vendor_code')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" name="vendor_code" class="form-control" value="<?= set_value('vendor_code');  ?>" placeholder="Enter vendor code" data-parsley-required="true" required/>
