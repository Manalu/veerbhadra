            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <div class="row">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?= base_url().'site/create'; ?>"><i class="fa fa-plus-square" aria-hidden="true"></i>Create New Site</a></li>
                </ol>
              </div>
            
              <div class="row">
                <div class="page-heading">
                  <h3>Create New Site</h3><hr>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="row">
                    <form id="create_site_form" action="<?= base_url().'site/save/new'; ?>" method="post">
                      ...
                      <div class="form-group <?php if(strlen(form_error('customer_id')) != 0) echo 'has-error'; ?>">
                        ...
                        <select name="customer_id" class="form-control" data-parsley-required="true" data-parsley-type="integer" required>
                          ...
                          <?php foreach ($customer_data as $key => $value): ?>
                              <?php if($value['customer_id'] === set_value('customer_id')): ?>
                      ...
                      <div class="form-group <?php if(strlen(form_error('site_name')) != 0) echo 'has-error'; ?>">
                        ...
                        <input type="text" class="form-control" name="site_name" value="<?= set_value('site_name');  ?>" placeholder="Enter site name" data-parsley-minlength="3" data-parsley-maxlength="100" data-parsley-required="true" required/>
                      ...
                      <div class="form-group <?php if(strlen(form_error('site_address')) != 0) echo 'has-error'; ?>">
                        ...
                        <textarea name="site_address" class="form-control" rows="4" placeholder="Enter address" data-parsley-minlength="15" data-parsley-maxlength="300" data-parsley-required="true" required><?= set_value('site_address');  ?></textarea>
                      ...
                      <div class="form-group <?php if(strlen(form_error('site_desc')) != 0) echo 'has-error'; ?>">
                        ...
                        <textarea name="site_desc" class="form-control" rows="4" placeholder="Enter address" data-parsley-minlength="15" data-parsley-maxlength="300" data-parsley-required="false"><?= set_value('site_desc');  ?></textarea>
